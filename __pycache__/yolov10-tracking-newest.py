...
class ObjectDetection:
    ...
    def process_track(self, frame, bbox, tracked_id, frame_width, frame_count):
    ...
    def __call__(self):
        ...
        while cap.isOpened():
            ...
            if TRACKER == "deepsort":
                ...
                for track in tracks:
                    ...
                    ltrb = track.to_ltrb()
                    self.process_track(frame, ltrb, track_id, frame_width, frame_count)
        ...
        print("Mota overall: ", abs(mota_mean))
